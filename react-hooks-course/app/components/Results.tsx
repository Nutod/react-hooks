...
function ResultsReducer(state: StateType, action: ActionType): StateType {
  switch (action.type) {
    case 'result':
      return {
        ...state,
...
const dispatchError = (dispatch: React.Dispatch<ActionType>, message: string) =>
...
export default function Results({
  ...
  React.useEffect(() => {
    ...
    battle([playerOne, playerTwo])
      .then(players => {
        dispatchResults(dispatch, players)
      })
      .catch(({ message }) => {
