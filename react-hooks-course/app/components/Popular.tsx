...
function LanguagesNav({
  ...
  selected: Languages
  onUpdateLanguage: (param: Languages) => void
}) {
...
export default function Popular() {
  ...
  const [repos, setRepos] = React.useState<{ [index: string]: Repo[] }>({})
  ...
  const updateLanguage = (selectedLanguage: Languages) => {
    ...
    if (!repos[selectedLanguage]) {
      fetchPopularRepos(selectedLanguage)
        .then(data => {
          setRepos({ [selectedLanguage]: data })
        })
        .catch(() => {
