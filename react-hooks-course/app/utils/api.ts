import { IPlayer, IProfile, IRepo } from '../types'
...
function getProfile(username: string): Promise<IProfile> {
...
function getRepos(username: string): Promise<IRepo[]> {
  return fetch(
...
export function fetchPopularRepos(language: string): Promise<IRepo[]> {
